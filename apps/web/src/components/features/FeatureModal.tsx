      ...
      <Dialog as="div" className="relative z-30" onClose={() => setIsOpen(false)}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="overflow-y-scroll w-full max-w-md h-96 transform overflow-hidden rounded-lg bg-white dark:bg-coal p-6 text-left align-middle shadow-xl transition-all">
                <Dialog.Title
                  as="h3"
                ...
                <div className="overflow-y-scroll prose dark:prose-invert prose-base prose-headings:my-2">
