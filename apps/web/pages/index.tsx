...
import GridLine from '../components/general/GridLine'
import { useMediaQuery } from 'react-responsive'
import { Compass } from '../components/Compass'
import { NextSeo } from 'next-seo'
// @ts-ignore
import Terminal from '@joeashworth/react-animated-term'
import terminalLines from '../const/terminalLines'
      ...
      <section id="hero" className="w-full min-h-screen flex flex-col justify-start md:justify-around">
        <div className="flex flex-col md:flex-row justify-center items-center z-30 mt-20 md:mt-10">
          <div id="hero-left" className="max-w-[600px] md:ml-5 lg:mr-20">
            ...
            <h4 className="animate-in fade-in zoom-in w-full text-center md:text-left mt-2 md:mt-0 text-indigo-300 font-bold text-2xl md:text-3xl lg:text-4xl md:pl-1 xl:pl-2">
          ...
          <div id="hero-right" className="overflow-hidden">
            {isLarge && (
              <div className="w-[750px] h-auto">
                <Image src={WebGraphic} layout="responsive" draggable={false} placeholder="blur" priority alt="Hero" />
              </div>
            )}
          </div>
        </div>
